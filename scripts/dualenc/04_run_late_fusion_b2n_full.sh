...
DATASETS_STR=${DATASETS:-"imagenet caltech101 oxford_pets stanford_cars oxford_flowers food101 fgvc_aircraft sun397 dtd eurosat ucf101"}
...
python scripts/dualenc/summarize_late_fusion.py \
  ...
  --output "$ROOT/summary_tables/dualenc/late_fusion_b2n_full.md" \
  --b2n

echo "[DONE] summary: $ROOT/summary_tables/dualenc/late_fusion_b2n_full.md"
