...
SOURCE_SPLITS=${SOURCE_SPLITS:-"unknown val test train base all"}
TARGET_DATASETS=${TARGET_DATASETS:-"dtd eurosat oxford_pets"}
...
RUN_DIR="$OUT_ROOT/imagenet_cache_b2n_sanity/${FUSION_MODE}"
mkdir -p "$RUN_DIR"
